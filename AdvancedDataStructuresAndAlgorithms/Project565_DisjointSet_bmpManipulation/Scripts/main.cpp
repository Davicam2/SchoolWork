...
int runTests() {
...

   {
	 ...
	 quantizeImage("test1.bmp", "test1-cc-Quantized.bmp", 16);

	 connectedComponents("test2.bmp", "test2-cc.bmp", 10);
	 quantizeImage("test2.bmp", "test2-cc-Quantized.bmp", 16);

	 connectedComponents("test3.bmp", "test3-cc.bmp", 10);
	 quantizeImage("test3.bmp", "test3-cc-Quantized.bmp", 16);

	 connectedComponents("test4.bmp", "test4-cc.bmp", 10);
	 quantizeImage("test4.bmp", "test4-cc-Quantized.bmp", 16);

	 connectedComponents("test5.bmp", "test5-cc.bmp", 32);
	 quantizeImage("test5.bmp", "test5-cc-Quantized.bmp", 16);
