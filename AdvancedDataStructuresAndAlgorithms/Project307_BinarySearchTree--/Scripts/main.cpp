...
int runTests() {
 ...
 graph [ordering="out"]
	  ...
	  TEST(stringEquals(tree.toDot(), target));//1
 ...
 "8"
	  ...
	  TEST(stringEquals(tree.toDot(), target));//2
 ...
 "8" -> "3"
	  ...
	  TEST(stringEquals(tree.toDot(), target));//3
 ...
 "8" -> "12"
	  ...
	  TEST(stringEquals(tree.toDot(), target));//4
 ...
 "12" -> "15"
	  ...
	  TEST(stringEquals(tree.toDot(), target));//5
  }
 ...
 "8" -> "3"
     ...
     TEST(stringEquals(tree.toDot(), target));//6
   }
 ...
 "15" -> "12"
     ...
     TEST(stringEquals(tree.toDot(), target));//7
   }
 ...
 "14" -> "15"
     ...
     TEST(stringEquals(tree.toDot(), target));//8
   }
 ...
 "12" -> "13"
     ...
     TEST(stringEquals(tree.toDot(), target));//9
   }
...

   {
     ...
     tree.insert(7);
     tree.insert(5);
     TEST(tree.contains(11));//14
     TEST(tree.contains(7));//15
     TEST(tree.contains(5));//16
     TEST(!tree.contains(1));//17
     TEST(!tree.contains(6));//18

     TEST(tree.get(11) == 11);//19
     TEST(tree.get(7) == 7);//20
     TEST(tree.get(5) == 5);//21
   }
 ...
 "Sally 223 22" -> "Josh 363 35"
	   ...
	   TEST(stringEquals(tree.toDot(), target));//22

	   TEST(tree.contains(587));//23
	   TEST(tree.contains(223));//24
	   TEST(tree.contains(982));//25
	   TEST(!tree.contains(21));//26
	   TEST(!tree.contains(22));//27

	   TEST(tree.get(587).name() == "Joe");//28
	   TEST(tree.get(223).name() == "Sally");//29
